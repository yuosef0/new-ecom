...
export default function ReturnsPage() {
    ...
    useEffect(() => {
        async function load() {
            const data = await getPage('returns');
            if (data) {
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-lg bg-brand-primary/10 flex items-center justify-center">
                            <span className="material-icons-outlined text-brand-primary text-2xl">autorenew</span>
                        </div>
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Return & Exchange Page</h1>
                            <p className="mt-1 text-gray-600">Manage your Return & Exchange page content</p>
                        </div>
                    </div>
                </div>
            </div>
